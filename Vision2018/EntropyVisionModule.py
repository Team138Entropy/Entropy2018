...
class PythonDiceCounter:
    ...
    #Red
        ...
        thresholded = PythonDiceCounter.adaptiveThreshold(ret,0.95)
        thresholded = PythonDiceCounter.cleanupImage(thresholded,9)    
        lightContours = PythonDiceCounter.locateContours(thresholded,0,0)
    ...
    # turned to thresholded from "ret: 
        ...
        targetFound = 0
        if (lookforPeaks):
            xpeaks = PythonDiceCounter.findPeaks(xsum)
            ypeaks = PythonDiceCounter.findPeaks(ysum)
